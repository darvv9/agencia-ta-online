...
export const advogadosContent: NicheContent = {
  ...
  dores: {
    ...
    items: [
      ...
      {
        title:
          "Sem presença digital própria, é difícil sustentar a mesma percepção de credibilidade que escritórios maiores transmitem.",
      },
      {
        title:
          "Indicação continua sendo o único canal de chegada de novos clientes — sem nenhuma outra estrutura de apoio.",
      },
    ],
    closing:
      "Site institucional não substitui o trabalho jurídico. Ele apoia a credibilidade de quem ainda não te conhece — dentro do que a OAB permite.",
  },
  ...
  comoFunciona: {
    ...
    intro: "Processo direto, sem reuniões desnecessárias.",
    steps: [
      {
        title: "Conversa no WhatsApp",
        description:
          "Entendemos o escritório, áreas de atuação e o que você precisa comunicar.",
      },
      {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Sim. O domínio é registrado em nome do escritório, caso prefira. Textos, identidade e marca permanecem 100% seus.",
      },
    ],
  },
